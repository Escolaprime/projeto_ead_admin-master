<template>
  <div class="flex-1 flex flex-col overflow-hidden">
    <header class="p-5 border-b">
      <span class="text-4xl font-bold">Semana</span>
    </header>
    ...
    <main class="flex-1 flex gap-2 overflow-hidden">
      ...
      <section class="flex-1 flex overflow-hidden bg-gray-100">
        <transition enter-active-class="transition-all ease-out duration-100" enter-class="opacity-0"
          enter-to-class="opacity-100" leave-active-class="transition-all ease-out duration-75" leave-class="opacity-100"
...
export default {
  ...
  computed: {
    ...
    check() {
      return check_permission("etapas");
    },
  },
};
</script>